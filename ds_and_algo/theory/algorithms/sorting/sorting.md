...
For `small or nearly sorted Arrays`, [Insertion Sort](insertion_sort.md) is `faster than` [Bubble Sort](bubble_sort.md), [Selection Sort](selection_sort.md), [Merge Sort](merge_sort.md), [Quick Sort](quick_sort.md), [Heap Sort](heap_sort.md), and [Shellsort](https://en.wikipedia.org/wiki/Shellsort).
